...
import { HiShieldCheck, HiEye, HiCreditCard, HiGlobeAlt } from "react-icons/hi";
  ...
  useEffect(() => {
    ...
    setSettings({
      accountSettings: {
        ...
        twoFactorEnabled:
          savedSettings.accountSettings?.twoFactorEnabled || false,
      },
      privacySettings: {
        dataSharing: savedSettings.privacySettings?.dataSharing ?? true,
        profileVisibility:
          savedSettings.privacySettings?.profileVisibility || "public",
      },
      displaySettings: {
        theme: savedSettings.displaySettings?.theme || "system",
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      id="twoFactor"
                      checked={
                        settings.accountSettings?.twoFactorEnabled || false
                      }
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Allow sharing anonymous usage data
                      </p>
                    </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 rounded-xl p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    >
                      {settings.subscriptionInfo?.status?.toUpperCase() ||
                        "ACTIVE"}
                    </span>
                  </div>
