...
// NEW: Function to get unpurchased favorited courses
export const getUnpurchasedFavorites = async (userId) => {
  try {
    // This would need backend implementation
    const response = await api.get(`/favorites/${userId}/unpurchased`);
    return response.data || [];
  } catch (err) {
    console.error("Failed to fetch unpurchased favorites:", err);
    return [];
  }
};